    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupLessonDeadline", x => new { x.GroupId, x.LessonId });
                    table.ForeignKey(
                        name: "FK_GroupLessonDeadlines_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupLessonDeadlines_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLessonStatus", x => new { x.UserId, x.LessonId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupLessonDeadlines_LessonId",
                table: "GroupLessonDeadlines",
                column: "LessonId");
